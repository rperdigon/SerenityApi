...
public class SDFactory extends PageObject {
    ...
    public static Map<String, AbstractPage> map = new HashMap<String, AbstractPage>() {{
        put("HOMEpage", PageFactory.initElements(new SDFactory().getDriver(), BcncgroupHomePage.class));
        put("WHO WE AREpage", PageFactory.initElements(new SDFactory().getDriver(), BcncgroupWhoWeArePage.class));
    }};
